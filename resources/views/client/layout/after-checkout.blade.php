            ...
            <ul>
                ...
                <li class="cartmini__item p-rel d-flex align-items-start">
                    <div class="cartmini__thumb mr-15">
                        <a href="/productDetail/{{$n->id}}">
                            <img   src="{{asset('uploads/images/'.$n['productInfo']->thumnail)}}" alt="">
                        </a>
                    </div>
                    <div class="cartmini__content">
                        <h3 class="cartmini__title">
                            <a href="/productDetail/{{$n->id}}">{{$n['productInfo']->title}}</a>
                        </h3>
                              ...
                              <p>Đặt hàng thành công</p>
                                 ...
                                 <div class="card">
                                    ...
                                    <div class="card-body">
                                      ...
                                      <p class="card-text">Tên khách hàng: {{$order->name_order}}</p>
                                      <p class="card-text">SĐT: {{$order->phone}}</p>
