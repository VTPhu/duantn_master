    ...
    <body class="fixed-left" >
        ...
        <div id="wrapper">
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="calendar.html" class="waves-effect"><i class="mdi mdi-calendar"></i><span> Category </span></a>
                            </li>
            ...
            <!-- ============================================================== -->
            <div class="content-page " style="margin-top:10px;padding-left:350px; background: url(https://cdn.sforum.vn/sforum/wp-content/uploads/2022/05/20-4.jpg);">
                <!-- Start content -->
                <div class="content">
                    <div class="row ">
                        <div class="col-sm-12 col-xs-12 col-md-8 card-box " >
