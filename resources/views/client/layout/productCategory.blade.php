                                ...
                                <div class="widget-category-list">
                                    ...
                                    @foreach($categorys as  $c)
                                            <div class="single-widget-category">
                                                ...
                                                <label for="cat-item-1"><a href="/productCategory/{{$c->id}}">{{$c->name}}</a><span>(12)</span></label>
                                            </div>
                                        @endforeach
                                    </form>
                                </div>
                                        ...
                                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".1s">
                                                <div class="product-thumb">
                                                    ...
                                                    @if($p->saled)
                                                    <span class="discount discount-1 p-abs">{{$p->saled}}%</span>
                                                    @endif
                                    ...
                                    <div class="product-wrap">
                                            ...
                                            <div class="row align-items-xl-center">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                                    <div class="product-thumb mr-30 product-thumb-list">
                                                        <img src="assets/img/products/fashion/20.jpg" alt="#">
                                                        <img src="assets/img/products/fashion/20-1.jpg" alt="#">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row align-items-xl-center">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                                    <div class="product-thumb mr-30 product-thumb-list">
                                                        ...
                                                        <img src="assets/img/products/fashion/1-1.jpg" alt="#">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="puik-product-content puik-product-list-content">
                                        ...
                                        <div class="single-product mb-30 puik-list-product-wrap">
                                            <div class="row align-items-xl-center">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                                    <div class="product-thumb mr-30 product-thumb-list">
                                                        <img src="assets/img/products/fashion/2.jpg" alt="#">
                                                        <img src="assets/img/products/fashion/2-1.jpg" alt="#">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="puik-product-content puik-product-list-content">
                                        ...
                                        <div class="single-product mb-30 puik-list-product-wrap">
                                            <div class="row align-items-xl-center">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                                    <div class="product-thumb mr-30 product-thumb-list">
                                                        <img src="assets/img/products/fashion/3.jpg" alt="#">
                                                        <img src="assets/img/products/fashion/3-1.jpg" alt="#">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="puik-product-content puik-product-list-content">
                                        ...
                                        <div class="single-product mb-30 puik-list-product-wrap">
                                            <div class="row align-items-xl-center">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                                    <div class="product-thumb mr-30 product-thumb-list">
                                                        <img src="assets/img/products/fashion/4.jpg" alt="#">
                                                        <img src="assets/img/products/fashion/4-1.jpg" alt="#">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="puik-product-content puik-product-list-content">
                                        ...
                                        <div class="single-product mb-30 puik-list-product-wrap">
                                            <div class="row align-items-xl-center">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                                    <div class="product-thumb mr-30 product-thumb-list">
                                                        <img src="assets/img/products/fashion/5.jpg" alt="#">
                                                        <img src="assets/img/products/fashion/5-1.jpg" alt="#">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="puik-product-content puik-product-list-content">
