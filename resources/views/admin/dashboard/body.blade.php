                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6">
                            <div class="card-box widget-box-one">
                                ...
                                <div class="wigdet-one-content">
                                    <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Category">DANH MỤC</p>
                                    
                                    <h2>{{$category}} <small><i class="mdi mdi-arrow-up text-success"></i></small></h2>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6">
                            <div class="card-box widget-box-one">
                                ...
                                <div class="wigdet-one-content">
                                    <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Product">SẢN PHẨM</p>
                                    <h2>{{$product}}<small><i class="mdi mdi-arrow-down text-danger"></i></small></h2>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6">
                            <div class="card-box widget-box-one">
                                ...
                                <div class="wigdet-one-content">
                                    <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Post">BÀI VIẾT</p>
                                    <h2>{{$post}}<small><i class="mdi mdi-arrow-up text-success"></i></small></h2>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6">
                            <div class="card-box widget-box-one">
                                ...
                                <div class="wigdet-one-content">
                                    ...
                                    <h2>{{$order}}<i class="mdi mdi-arrow-down text-danger"></i></small></h2>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6">
                            <div class="card-box widget-box-one">
                                ...
                                <div class="wigdet-one-content">
                                    <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Total Users">Người dùng</p>
                                    <h2>{{$user}}<small><i class="mdi mdi-arrow-down text-danger"></i></small></h2>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6">
                            <div class="card-box widget-box-one">
                                ...
                                <div class="wigdet-one-content">
                                    ...
                                    <h2>{{$admin}}<small><i class="mdi mdi-arrow-up text-success"></i></small></h2>
