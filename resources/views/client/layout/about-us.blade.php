...
<section class="page__title-area pt-30 pb-0">
                <div class="page__title-wrapper text-center">
                    <h3 class="gioithieu" style="font-size: 60px;
    color: #222;
    font-weight: 400;
    line-height: 1;
    margin-bottom: 20px;">Giới thiệu</h3>
                </div>
</section>
            ...
            <div class="col-xxl-8 col-xl-10">
                <div class="about__history-wrapper">
                    <div class="about__history-title-area">
                        <span class="about__history-title-pre">LỊCH SỬ HÌNH THÀNH</span>
                        <h3 class="about__history-title">  </h3>
                    </div>
                    <p class="about__history-text">Được thành lập vào cuối năm 2016 trong bối cảnh thời trang streetstyle dần nhen nhóm vào thị trường Việt Nam. Sau 6 năm phát triển, GEN Z - Street Wear Eazy với slogan Young kids with a mission™ đã chiếm được tình cảm của hầu hết các bạn trẻ yêu mến thời trang đường phố trên khắp cả nước. 
                    Thời trang vận hành như dòng thời gian không ngừng dịch chuyển.</p>
            
                    <p class="about__history-text">Hiểu được điều này, GenzStore luôn biết cách làm mới mình bằng cách liên tục cho ra đời những sản phẩm không chỉ chất lượng mà còn có thiết kế vô cùng độc đáo, mới lạ và ấn tượng, đảm bảo khiến bạn trông trendy hơn bao giờ hết. </p>
                    <div class="about__history-title-area">
                        <span class="about__history-title-pre">QUÁ TRÌNH PHÁT TRIỂN </span>
                    </div>
                    <p>"Ước mơ của chúng mình là đưa thương hiệu GEN Z trở thành cái tên quen thuộc với các bạn trẻ trên cả nước, vươn xa đến các quốc gia lân cận.”.</p>
                    <p>Sau 6 năm hình thành và phát triển, SWE đã trở thành một trong những thương hiệu thời trang được các tín đồ streetstyle săn đón. Hiện tại, GEN Z đã chính thức có mặt trên 4 tỉnh thành: Hồ Chí Minh, Hà Nội, Biên Hoà, Cần Thơ với nhiều chi nhánh. </p>
                    <p>Tại thành phố Hồ Chí Minh, GEN Z có 5 chi nhánh:<br>
                        - 44A Trần Quang Diệu, Quận 3.<br>
                        - TNP Lý Tự Trọng, Quận 1.    <br>
                        - TNP Lê Lai, Quận 1.<br>
                        - 350 Điện Biên Phủ, Bình Thạnh.<br>
                        - 136 Nguyễn Hồng Đào, Tân Bình.</p>
                    
                        <p>Tại thủ đô Hà Nội, GEN Z có 2 chi nhánh:<br>
                        - TNP Vincom Bà Triệu, Hai Bà Trưng.<br>
                        - 73 Đông Các, Ô Chợ Dừa.</p>

                        <p>Tại Biên Hoà, GEN Z có 1 chi nhánh:<br>
                        - Vincom Shophouse Biên Hòa - Phạm Văn Thuận, Tân Mai.</p>

                        <p>Tại Cần Thơ, GEN Z có 1 chi nhánh:<br>
                        - Vincom Shophouse Xuân Khánh - 209 Đường 30/4, Quận Ninh Kiều.</p>
                </div>
            </div>
        </div>
    </div>
