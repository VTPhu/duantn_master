                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="single-blog blog-grid mb-30">
                                        <div class="blog-thumb w-img">
                                            <a href=""><img src="{{asset('uploads/images/'.$b->thumnail_url)}}" alt="#"></a>
                                        </div>
                                        <div class="blog-content">
                                            <div class="blog-meta">
                                                 <a href="#"><span>Ngày đăng: {{Carbon::parse($b->created_at)->diffForHumans() }}</span></a> / Bởi <a
                                                    href="#"><span>{{$b->tacgia}}</span></a>.
                                            </div>
                                            <h5 class="blog-title blog-title-1">
                                                <a href="{{url('/blog/news',[$b->slug])}}">{{$b->title}}</a>
                                                </h5>
                                            <p>{{$b->sumary}}</p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-4">
                        <div class="blog__sidebar">
                            <div class="sidebar__widget sidebar__widget-padding mb-30">
                                <h5 class="sidebar__widget-title mb-30">BÀI VIẾT MỚI NHẤT</h5>
                                <div class="sidebar__post">
                                    <div class="rc-post-wrapper">
                                    @foreach ($blog as $b)
                                        <div class="rc-post-item d-flex align-items-start">
                                            <div class="rc-post-content">
                                                <h5 class="rc-post-title">
                                                    <a href="{{url('/blog/news',[$b->id])}}">{{$b->title}}</a>
                                                </h5>
                                                <div class="rc-post-meta">
                                                    <span>{{Carbon::parse($b->created_at)->diffForHumans() }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
