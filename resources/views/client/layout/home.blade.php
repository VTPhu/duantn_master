...
<body>
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-6 col-sm-4 col-4">
                            <div class="header-left p-rel d-flex align-items-center">
                                <div class="logo pr-55 d-inline-block">
                                    <a href="index.html"><img src="client/assets/img/logo/logo-white.png" alt="#"></a>
                                </div>
                                <div class="main-menu">
                                    <nav id="mobile-menu">
                                        <ul>
                                                    ...
                                                    <li class="d-none d-lg-block">
                                                        <div class="menu-banner-wrapper p-rel">
                                                            <a class="w-img" href="shop.html">
                                                                <img src="assets/img/banner/menu/banner-women.jpg"
                                                                    alt="">
                                                            </a>
                                            ...
                                            <li>
                                                ...
                                                <ul class="sub-menu">
                                                    <li><a href="blog.html">Tin tức chính</a></li>
                            ...
                            <div class="header-right-wrapper d-flex align-items-center justify-content-end">
                                <div class="header-right d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="header-icon d-inline-block ml-30">
                                        <a href="javascript:void(0)" class="search-toggle d-none d-sm-inline-block"><i
                                                class="fal fa-search"></i></a>
                                        <a href="wishlist.html" class="d-none d-xl-inline-block"><i
                                                class="fal fa-heart"></i><span>2</span></a>
                ...
                <div class="modal-content">
                    <div class="cartmini__wrapper">
                        ...
                        <div class="cartmini__bottom">
                            <a href="cart.html" class="s-btn w-100 mb-20">Xem giỏ hàng</a>
                            <a href="checkout.html" class="s-btn s-btn-2 w-100">Thanh toán</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <div class="offcanvas__wrapper">
                        <div class="offcanvas__top d-flex align-items-center mb-60 justify-content-between">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="client/assets/img/logo/logo-black.png" alt="logo">
                                </a>
                            </div>
                        ...
                        <div class="offcanvas__content p-relative z-index-1">
                            ...
                            <div class="offcanvas__action mb-15 ">
                                <a href="wishlist.html" class="has-tag">
                                    <svg viewBox="0 0 22 22">
                                        <path
                                            d="M20.26,11.3c2.31-2.36,2.31-6.18-0.02-8.53C19.11,1.63,17.6,1,16,1c0,0,0,0,0,0c-1.57,0-3.05,0.61-4.18,1.71c0,0,0,0,0,0
    ...
    <main
        ...
        <!-- slider area start -->
        <section class="slider-area pb-20 p-rel" style="background-color:white">
            <div class="slider-active dot-style dot-style-1 dot-right">
                <div class="single-slider slider-height" data-background="client/assets/img/slider/anh2.jpg">
                </div>
                {{-- <div class="single-slider slider-height" data-background="client/assets/img/slider/slider-2.jpg">
                </div>
                <div class="single-slider slider-height" data-background="client/assets/img/slider/slider-3.jpg">
                </div>
                <div class="single-slider slider-height" data-background="client/assets/img/slider/slider-1.jpg">
                </div> --}}
            </div>
        ...
        <div class="top-selling-area top-selling-padding pb-100" style=" background-color: white">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".1s">
                            <div class="product-thumb">
                                <img src="uploads/images/{{$pro->thumnail}}" alt="#">
                                <img src="uploads/images/{{$pro->thumnail}}" alt="#">
                            ...
                            <div class="product-content" style="text-align: center;font-weight: bold;">
                                <h4 class="pro-title pro-title-1" style="font-weight: bold;font-size:17px"><a href="product-details.html">{{$pro->title}}</a></h4>
                                <div class="pro-price">
                            ...
                            <div class="tab-content mb-10" id="productModalThumb">
                                <div class="tab-pane fade show active" id="pro-1" role="tabpanel"
                                    ...
                                    <div class="product__modal-thumb w-img">
                                        <img src="client/assets/img/products/modal/product-modal-1.jpg" alt="">
                                    </div>
                                </div>
