                                            ...
                                            <tbody >
                                                <tr>
                                                    ...
                                                    <td class="text-center font-size-10">
                                                        <a href="/admin/edit/brand/{{$b->id}}" class="text-gray m-r-5"><i class="ti-pencil"></i></a>
                                                        <a href="/admin/deleteBrand/{{$b->id}}" onclick="del(event,{{$b->id}})"  class="text-gray"><i class="ti-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </tbody>
